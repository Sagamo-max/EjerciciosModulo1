...
y es que Adriana y Sebastian son amantes de los números pares. De manera que quieren 
dividir la sandía en dos partes no necesariamente iguales pero ambas deben ser pares.  
Escriba una función en el que pueda ingresar el peso de la sandía en kilogramos y la 
respuesta sea: 
...
public class Ejercicio12 {
    public static void main(String[] args) {
        ...
        System.out.print("Ingrese el peso de la sandia en kilogramos: ");
        var pesoSandia = scanner.nextInt();
